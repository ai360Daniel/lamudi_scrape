...
ESTADOS = [ "campeche","chiapas", "colima", "distrito-federal",
    "durango", "nayarit", "tabasco", "tlaxcala", "veracruz", "zacatecas"
]
...
def main():
    ...
    for tipo in TIPOS_PROPIEDAD:
        ...
        try:
            # Descargar datos
            failed = scrape_y_guardar_fallidos(start_url, output_filename, usar_gcs=USAR_GCS)
